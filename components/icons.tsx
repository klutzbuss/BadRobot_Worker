...
export const BandageIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M12 9.75L14.25 12m0 0l2.25 2.25M14.25 12l2.25-2.25M14.25 12L12 14.25m-2.58 4.92l-6.375-6.375a1.125 1.125 0 010-1.59L9 4.5l4.5 4.5 6.375 6.375a1.125 1.125 0 01-1.59 1.59l-6.375-6.375z" />
    </svg>
);
...
export const RobotIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
      ...
      <path strokeLinecap="round" strokeLinejoin="round" d="M10.5 12a1.5 1.5 0 11-3 0 1.5 1.5 0 013 0z" />
      ...
      <path strokeLinecap="round" strokeLinejoin="round" d="M7.5 16.5v3" />
      <path strokeLinecap="round" strokeLinejoin="round" d="M16.5 16.5v3" />
    </svg>
);
...
// FIX: Changed title attribute to a <title> element to fix TypeScript error and correctly provide a tooltip.
